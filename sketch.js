...
function preload() {
  ...
  ENEMY_GREY_UFO=loadAnimation("ENEMY_GREY_UFO1.png","ENEMY_GREY_UFO2.png");

  ENEMY_SILVER_UFO=loadAnimation("ENEMY_SILVER_UFO1.png","ENEMY_SILVER_UFO2.png");
...
function ENEMY_GREY() {
   ...
   grey_UFO.velocityX = 15;
   grey_UFO.scale = 0.1;

   grey_UFO_grp.add(grey_UFO);
   if(PROTON_LEFT.isTouching(grey_UFO_grp)){
...
function ENEMY_GLOOM() {
  ...
  GLOOM = createSprite(640,Math.round(random(20,600)));
  ...
  gloom_grp.add(GLOOM);
  if(PROTON_LEFT.isTouching(gloom_grp))
  {
...
function ENEMY_GLOOM2() {
  ...
  GLOOM2 = createSprite(640,Math.round(random(20,600)));
